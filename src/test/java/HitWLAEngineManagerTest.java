...
public class HitWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HitWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HitIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HitIW/InitOutcome.xml").getDocumentElement();
